...
def assert_array_equal(x, y, err_msg="", verbose=True, *, strict=False):
    ...
    Max relative difference: 1.4135798584282295e-16  # doctest: +SKIP
     x: torch.ndarray([1.0000, 3.1416,    nan], dtype=float64)
     y: torch.ndarray([1.0000, 3.1416,    nan], dtype=float64)
